...
public class IllformedLocaleException extends RuntimeException {
     ...
     * detail com.isliujiao.gpt.chatgpt.message and -1 as the error index.
     */
     ...
     * given com.isliujiao.gpt.chatgpt.message and -1 as the error index.
     *
     * @param message the com.isliujiao.gpt.chatgpt.message
     */
    ...
    /**
     * Constructs a new <code>IllformedLocaleException</code> with the
     * given com.isliujiao.gpt.chatgpt.message and the error index.  The error index is the approximate
