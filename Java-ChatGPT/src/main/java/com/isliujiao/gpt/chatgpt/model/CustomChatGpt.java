package com.isliujiao.gpt.chatgpt.model;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.isliujiao.gpt.chatgpt.message.ChatGptMessage;
import com.isliujiao.gpt.chatgpt.message.ChatGptRequestParameter;
import com.isliujiao.gpt.chatgpt.message.ChatGptResponseParameter;
import com.isliujiao.gpt.chatgpt.message.Choices;
...
public class CustomChatGpt {
    ...
    public String getAnswer(CloseableHttpClient client, String question) {
        ...
        // 设置请求参数
//        chatGptRequestParameter.addMessages(new ChatGptMessage("assistant", "你是一个中国人，回答是以【在下】开头"));
